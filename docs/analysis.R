...
# 7. What is the ratio of maximum Black prisoners to the maximum total population
# in a location? May need to do in several steps. Store final answer in `final_ratio`
...
# 8. What is the ratio of maximum White prisoners to the maximum total population?
...
# are related -> use scatterplot 
  `white_vs_latinx_population` <- incarceration_trends %>% 
    drop_na() %>%
    select(white_pop_15to64, latinx_pop_15to64, region) 
